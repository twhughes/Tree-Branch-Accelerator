...
Estrength = [];
disp(size(Estrength));
Edir      = zeros(num_coords, length(crange), length(wrange), length(hrange), length(srange));
        ...
        for h = hrange
           ...
           %         steps = steps + 1;
                 ...
                 %   opts.withobjsrc = true;
                    ...
                    %make for loop in future
                    %{
                    Edir(1, 1, ci, wi, hi, si) = [Edir(1, 1, ci, wi, hi, si), abs(E1{Axis.x}.array(Xsize1,Ysize1,Zsize1))^2];
                    Edir(1, 2, ci, wi, hi, si) = [Edir(1, 2, ci, wi, hi, si), abs(E1{Axis.y}.array(Xsize1,Ysize1,Zsize1))^2];
                    Edir(1, 3, ci, wi, hi, si) = [Edir(1, 3, ci, wi, hi, si), abs(E1{Axis.z}.array(Xsize1,Ysize1,Zsize1))^2];
                    Edir(2, 1, ci, wi, hi, si) = [Edir(2, 1, ci, wi, hi, si), abs(E2{Axis.x}.array(Xsize2,Ysize2,Zsize2))^2];
                    Edir(2, 2, ci, wi, hi, si) = [Edir(2, 2, ci, wi, hi, si), abs(E2{Axis.y}.array(Xsize2,Ysize2,Zsize2))^2];
                    Edir(2, 3, ci, wi, hi, si) = [Edir(2, 3, ci, wi, hi, si), abs(E2{Axis.z}.array(Xsize2,Ysize2,Zsize2))^2];
                    Edir(3, 1, ci, wi, hi, si) = [Edir(3, 1, ci, wi, hi, si), abs(E3{Axis.x}.array(Xsize3,Ysize3,Zsize3))^2];
                    Edir(3, 2, ci, wi, hi, si) = [Edir(3, 2, ci, wi, hi, si), abs(E3{Axis.y}.array(Xsize3,Ysize3,Zsize3))^2];
                    Edir(3, 3, ci, wi, hi, si) = [Edir(3, 3, ci, wi, hi, si), abs(E3{Axis.z}.array(Xsize3,Ysize3,Zsize3))^2];
                    Edir(4, 1, ci, wi, hi, si) = [Edir(4, 1, ci, wi, hi, si), abs(E4{Axis.x}.array(Xsize4,Ysize4,Zsize4))^2];
                    Edir(4, 2, ci, wi, hi, si) = [Edir(4, 2, ci, wi, hi, si), abs(E4{Axis.y}.array(Xsize4,Ysize4,Zsize4))^2];
                    Edir(4, 3, ci, wi, hi, si) = [Edir(4, 3, ci, wi, hi, si), abs(E4{Axis.z}.array(Xsize4,Ysize4,Zsize4))^2];                    
                    Edir(5, 1, ci, wi, hi, si) = [Edir(5, 1, ci, wi, hi, si), abs(E5{Axis.x}.array(Xsize5,Ysize5,Zsize5))^2];
                    Edir(5, 2, ci, wi, hi, si) = [Edir(5, 2, ci, wi, hi, si), abs(E5{Axis.y}.array(Xsize5,Ysize5,Zsize5))^2];
                    Edir(5, 3, ci, wi, hi, si) = [Edir(5, 3, ci, wi, hi, si), abs(E5{Axis.z}.array(Xsize5,Ysize5,Zsize5))^2];  
                    disp(wi);
                   %} 
                    Estrength = [ Estrength, ...
